...
public class DateUtils{
    ...
    public static String addDays(String startDateStr, int day){
        Date startDate = DateUtils.strToDate(startDateStr);
        startDate = DateUtils.addDate(startDate,0,0,day,0,0,0,0);
        return DateUtils.parseDateToStr(startDate, DateUtils.DATE_FORMAT_YYYYMMDD);
    }
     ...
     * @return 相差天数
     */
    public static Long getDistanceDays(String str1, String str2, String format) throws Exception{
    ...
    public static String currentDate(){
        return parseDateToStr(new Date(), DateUtils.DATE_FORMAT_YYYYMMDD);
    }
